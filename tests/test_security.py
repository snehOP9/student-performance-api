...
class PasswordVerificationTests(unittest.TestCase):
    ...
    def test_zero_iteration_count_returns_false(self):
        malformed = f'{PBKDF2_PREFIX}$0$c2FsdA==$aGFzaA=='
    ...
    def test_unknown_hash_format_returns_false(self):
        self.assertFalse(verify_password('password', 'sha256$600000$c2FsdA==$aGFzaA=='))
